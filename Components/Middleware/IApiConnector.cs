...
namespace SpacedRepetitionSystem.Components.Middleware
{
  ...
  public interface IApiConnector
  {
    ...
    Task<TEntity> GetAsync<TEntity>(object id) where TEntity : IRootEntity, new(); 
    ...
    Task<List<TEntity>> GetAsync<TEntity>(IDictionary<string, object> searchParameters) where TEntity : IRootEntity, new();

    /// <summary>
    /// Updates an existing entity
    /// </summary>
    /// <param name="entity">The updated entity</param>
    Task<bool> PutAsync<TEntity>(TEntity entity) where TEntity : IRootEntity;

    /// <summary>
    /// Deletes an existing entity
    /// </summary>
    /// <param name="entity">The entity to delete</param>
    Task<bool> DeleteAsync<TEntity>(TEntity entity) where TEntity : IRootEntity;

    /// <summary>
    /// Creates a new entity
    /// </summary>
    /// <param name="entity">The new entity</param>
    Task<bool> PostAsync<TEntity>(TEntity entity) where TEntity : IRootEntity;
    ...
    Task<TReturn> PostAsync<TReturn>(string route, object value);

    /// <summary>
    /// Performs a post request to the specified route with value as content
    /// </summary>
    /// <param name="route">The route to post to</param>
    Task PostAsync(string route, object value);
  }
}